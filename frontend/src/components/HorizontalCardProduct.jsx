          ...
          ? loadingList.map((product, index) => (
              ...
              >
                ...
                <div className="p-4 grid w-full gap-2">
                  <p className="font-medium text-base md:text-lg text-ellipsis line-clamp-1 text-black bg-slate-200 animate-pulse p-1 rounded-full"></p>
                  <p className="capitalize text-slate-500 p-1 bg-slate-200  animate-pulse  rounded-full"></p>
                  <div className="flex gap-2 w-full">
                    <p className="text-slate-500 font-medium p-1 bg-slate-200 w-full animate-pulse  rounded-full"></p>
